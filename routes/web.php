...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['role:dokter'])->prefix('dokter')->group(function () {
        ...
        Route::get('/profile', [ProfileController::class, 'edit'])->name('dokter.profile.edit');
        Route::patch('/profile', [ProfileController::class, 'update'])->name('dokter.profile.update');
        Route::delete('/profile', [ProfileController::class, 'destroy'])->name('dokter.profile.destroy');
    });
        ...
        Route::prefix('obat')->group(function () {
            ...
            Route::get('/restore', [ObatController::class, 'restore'])->name('dokter.obat.restore'); // Menampilkan daftar obat terhapus
            Route::put('/restore/{id}', [ObatController::class, 'restoreItem'])->name('dokter.obat.restore.item'); // Mengembalikan 1 obat
        });
